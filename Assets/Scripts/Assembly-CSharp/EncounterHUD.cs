public class EncounterHUD : IxSceneDisplay
{
	...
	public EncounterHUD(global::UnityEngine.GameObject mainCanvas)
		: base(mainCanvas)
	{
	...
	public void InitializeShockerComponent()
	{
		...
		if (gameObject == null)
		{
			global::UnityEngine.Debug.LogError("EncounterHUD InitializeShockerComponent - The current HUD layout has no Shocker Component");
		}
	...
	public void InitializeBatteryComponent(SurgeMechanicUIHandler surgeHandler, global::System.Collections.Generic.List<BatteryColorToValue> colorValues, global::UnityEngine.Color surgeColor)
	{
	...
	{
		global::UnityEngine.GameObject gameObject = _components.TryGetComponent<global::UnityEngine.RectTransform>("HaywireIndicator").gameObject;
		if (gameObject == null)
		{
			global::UnityEngine.Debug.LogError("EncounterHUD InitializeHaywireIndicatorComponent - The current HUD layout has no Haywire Indicator Component");
		}
		...
		_activeComponents.Add(EncounterHUD.HUDComponent.HaywireIndicator, haywireIndicatorUIComponent);
	}
