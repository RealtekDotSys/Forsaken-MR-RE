namespace DigitalRuby.ThunderAndLightning
{
	public static class PathGenerator
	{
		...
		private static float Distance2D(ref global::UnityEngine.Vector3 point1, ref global::UnityEngine.Vector3 point2)
		{
		...
		private static float Distance3D(ref global::UnityEngine.Vector3 point1, ref global::UnityEngine.Vector3 point2)
		{
			float num = point2.x - point1.x;
			float num2 = point2.y - point1.y;
		...
		private static void GetCurvePoint2D(ref global::UnityEngine.Vector3 start, ref global::UnityEngine.Vector3 end, ref global::UnityEngine.Vector3 ctr1, ref global::UnityEngine.Vector3 ctr2, float t, out global::UnityEngine.Vector3 point)
		{
			float num = t * t;
			float num2 = num * t;
			...
			point = new global::UnityEngine.Vector3(x, y, 0f);
		}

		private static void GetCurvePoint3D(ref global::UnityEngine.Vector3 start, ref global::UnityEngine.Vector3 end, ref global::UnityEngine.Vector3 ctr1, ref global::UnityEngine.Vector3 ctr2, float t, out global::UnityEngine.Vector3 point)
		{
			float num = t * t;
			float num2 = num * t;
			...
			point = new global::UnityEngine.Vector3(x, y, z);
		}

		private static void CalculateNonuniformCatmullRom(float p1, float p2, float p3, float p4, float distance1, float distance2, float distance3, out global::UnityEngine.Vector4 point)
		{
			...
			point = new global::UnityEngine.Vector4(p2, num, -3f * p2 + 3f * p3 - (num2 + 2f * num), num + num2 + (2f * p2 - 2f * p3));
		}

		private static float CalculatePolynomial(ref global::UnityEngine.Vector4 point, float t)
		{
			float num = t * t;
			float num2 = num * t;
		...
		private static void GetSplinePoint2D(ref global::UnityEngine.Vector3 point1, ref global::UnityEngine.Vector3 point2, ref global::UnityEngine.Vector3 point3, ref global::UnityEngine.Vector3 point4, float t, out global::UnityEngine.Vector3 point)
		{
			...
			point = new global::UnityEngine.Vector3(CalculatePolynomial(ref point5, t), CalculatePolynomial(ref point6, t), 0f);
		}

		private static void GetSplinePoint3D(ref global::UnityEngine.Vector3 point1, ref global::UnityEngine.Vector3 point2, ref global::UnityEngine.Vector3 point3, ref global::UnityEngine.Vector3 point4, float t, out global::UnityEngine.Vector3 point)
		{
			...
			point = new global::UnityEngine.Vector3(CalculatePolynomial(ref point5, t), CalculatePolynomial(ref point6, t), CalculatePolynomial(ref point7, t));
		}

		public static float CreateCurve(global::System.Collections.Generic.ICollection<global::UnityEngine.Vector3> path, global::UnityEngine.Vector3 start, global::UnityEngine.Vector3 end, global::UnityEngine.Vector3 ctr1, global::UnityEngine.Vector3 ctr2, int numberOfSegments, float startT)
		{
			numberOfSegments = global::System.Math.Min(1024, global::System.Math.Max(numberOfSegments, 4));
		...
		public static bool CreateSpline(global::System.Collections.Generic.ICollection<global::UnityEngine.Vector3> path, global::System.Collections.Generic.IList<global::UnityEngine.Vector3> points, int numberOfSegments, bool closePath)
		{
			if (points.Count < 4)
			{
				return false;
			...
			for (int i = 0; i < num; i++)
			{
				...
				global::UnityEngine.Vector3 point = points[index];
				global::UnityEngine.Vector3 point2 = points[i];
				global::UnityEngine.Vector3 point3 = points[num5];
				global::UnityEngine.Vector3 point4 = points[num6];
				float num7;
				global::UnityEngine.Vector3 point5;
				if (Is2D)
				{
		...
		public static bool CreateSplineWithSegmentDistance(global::System.Collections.Generic.ICollection<global::UnityEngine.Vector3> path, global::System.Collections.Generic.IList<global::UnityEngine.Vector3> points, float distancePerSegment, bool closePath)
		{
			...
			for (int i = 0; i < num; i++)
			{
				...
				global::UnityEngine.Vector3 point = points[index];
				global::UnityEngine.Vector3 point2 = points[i];
				global::UnityEngine.Vector3 point3 = points[num4];
				global::UnityEngine.Vector3 point4 = points[num5];
				global::UnityEngine.Vector3 point5;
				if (Is2D)
				{
					float value = 1f / (Distance2D(ref point3, ref point2) / distancePerSegment);
					value = global::UnityEngine.Mathf.Clamp(value, 0.00390625f, 1f);
