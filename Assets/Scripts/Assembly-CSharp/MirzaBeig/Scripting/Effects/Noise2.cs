namespace MirzaBeig.Scripting.Effects
{
	...
	public static class Noise2
	{
		...
		public static float perlinUnoptimized(float x, float y, float z)
		{
			...
			float t2 = fade(num5);
			float t3 = fade(num4);
			float num10 = grad(perm[num + perm[num2 + perm[num3]]], num4, num5, num6);
			float to = grad(perm[num + perm[num2 + perm[num9]]], num4, num5, z2);
			float num11 = lerp(num10, to, t);
			float num12 = grad(perm[num + perm[num8 + perm[num3]]], num4, y2, num6);
			to = grad(perm[num + perm[num8 + perm[num9]]], num4, y2, z2);
			float to2 = lerp(num12, to, t);
			float num13 = lerp(num11, to2, t2);
			float num14 = grad(perm[num7 + perm[num2 + perm[num3]]], x2, num5, num6);
			to = grad(perm[num7 + perm[num2 + perm[num9]]], x2, num5, z2);
			float num15 = lerp(num14, to, t);
			float num16 = grad(perm[num7 + perm[num8 + perm[num3]]], x2, y2, num6);
			to = grad(perm[num7 + perm[num8 + perm[num9]]], x2, y2, z2);
			to2 = lerp(num16, to, t);
			float to3 = lerp(num15, to2, t2);
			return 0.936f * lerp(num13, to3, t3);
		}
